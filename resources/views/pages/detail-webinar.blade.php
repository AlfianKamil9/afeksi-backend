            ...
            <div class="modal-body">
                ...
                <form action="{{ route('daftar-webinar', ['slug' => $data->slug_event]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 upload-file-wrapper">
                        ...
                        <input type="file" name="bukti_follow" id="upload-file" class="d-block" />
                        @error('bukti_follow')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="mb-3 upload-file-wrapper">
                        ...
                        <input type="file" name="bukti_linkedin" id="upload-file" class="d-block" />
                    ...
                    <div class="mb-3 upload-file-wrapper">
                        ...
                        <input type="file" name="bukti_share" id="upload-file" class="d-block" />
                        @error('bukti_share')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
