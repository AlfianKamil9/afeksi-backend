  ...
  <div class="d-flex pt-5 mt-5 justify-content-between flex-column flex-lg-row gap-5 text-center text-lg-start">
    <div class="left col-lg-5">
      ...
      <div class="text text-white mt-5">
        ...
        <p>
          Bersama-sama, mari kita belajar, berbagi, dan tumbuh dalam kualitas hubungan kita, agar hidup kita dipenuhi dengan cinta, kebahagiaan, dan
          kedamaian batin.
        </p>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="input-group password-container form-group">
        ...
        <div class="input-group-append button">
          <button class="btn rounded-0 rounded-end-2 bg-body-secondary" type="button">
  ...
  <div class="content col-lg-9 col-md-8">
    <div class="row d-flex">
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card mb-4">
          <img src="assets/img/kegiatan/campaignposter.png" alt="Image 1" />
          <div class="card-body">
            <p class="card-title fw-semibold">Embracing Equality: A Pathway to Dissolve Dating Violence</p>
