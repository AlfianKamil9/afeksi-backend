...
<div class="contents row">
      ...
      <div class="side col-lg-3 col-md-4 mb-5">
        <form method="get" action="{{ route('peers.konseling.process.pilih-konselor', $slug) }}">
        ...
        <div class="d-flex flex-column mt-4">
          ...
          <a href="{{ route('peers.konseling.konselor', $slug) }}" class="btn side-btn btn-outline">Hapus Filter</a>
        </div>
        </form>
      </div>
        ...
        <div class="row d-flex ps-3">
          @forelse ($data as $item)
              <div class="col-lg-6 p-2">
                <form action="{{ route('peers.konseling.process.pilih-konselor', $slug)}}" method="POST">
                  @csrf
